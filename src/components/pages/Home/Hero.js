            ...
            <Container>
                <div className="hero-content p-0 max-w-full flex-col lg:flex-row-reverse">
                    ...
                    <div className="w-full md:w-10/12 lg:w-6/12">
                        ...
                        <p className="py-4 md:py-6 lg:py-6 leading-7">Professional Frontend Web Developer! Working with Html5, CSS3, JavaScript, React JS, Node JS, MongoDB, Bootstrap & Tailwind CSS</p>
